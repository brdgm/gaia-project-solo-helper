<template>
  ...
  <div class="float-end m-2 w-25">
    <a href="https://boardgamegeek.com/boardgame/120677/gaia-project" target="_blank" rel="noopener">
      <img src="../assets/game-gaia-project.jpg" class="rounded shadow w-100" alt=""/>
    </a>
  </div>
  ...
  <p class="text-muted fst-italic">
    {{t('home.feedback')}}
    <a href="https://boardgamegeek.com/thread/2899814/brdgmme-gaia-project-solo-helper-web-application" target="_blank" rel="noopener">Board Game Geek Thread</a> |
    <a href="https://github.com/brdgm/gaia-project-solo-helper" target="_blank" rel="noopener">GitHub</a>
  </p>
  ...
  <p class="disclaimer">
    ...
    All art in this app is from <a href="https://www.feuerland-spiele.de/spiele/terra_mystica.php" target="_blank" rel="noopener">Gaia Project</a>.
